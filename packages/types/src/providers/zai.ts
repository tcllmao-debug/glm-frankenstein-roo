...
export const internationalZAiModels = {
        "glm-5.2": {
                ...
                description:
                        "GLM-5.2 is Zhipu's flagship reasoning model with a 202k context window and advanced hybrid thinking. State-of-the-art coding, agentic tool-use, and multi-step reasoning. Default model for GLM Frankenstein.",
        },
        "glm-4.5": {
                maxTokens: 16_384,
