        ...
        implements vscode.WebviewViewProvider, TaskProviderLike
{
      ...
      `
        ...
        > {
                ...
                // GLM Frankenstein: default to Z.ai (GLM-5.2) for full autonomy.
                ...
                if (providerSettings.apiProvider === "zai" && !providerSettings.apiModelId) {
                        providerSettings.apiModelId = "glm-5.2"
                }
                ...
                return {
                        ...
                        // GLM Frankenstein autonomy defaults — agent can act without prompts.
                        ...
                        // GLM Frankenstein: seed a generous default allowedCommands list so the
                        // agent can run common dev commands without prompting. Users can edit
                        // this list in Settings. This only applies when no list is configured.
                        allowedCommands: stateValues.allowedCommands ?? [
                                "git status", "git diff", "git log", "git branch", "git show",
                                "git add", "git restore", "git stash", "git checkout",
                                "ls", "pwd", "cat", "head", "tail", "wc", "find", "grep",
                                "echo", "which", "file", "stat",
                                "npm install", "npm run", "npm test", "npm ci", "npm ls",
                                "npx", "pnpm install", "pnpm run", "pnpm test", "yarn",
                                "node", "ts-node", "tsx", "tsc", "eslint", "prettier",
