...
export async function activate(context: vscode.ExtensionContext) {
        ...
        // GLM Frankenstein: stash context globally so the Frankenstein command
        // module can reach it without plumbing it through every layer.
...
export async function deactivate() {
        ...
        try {
                ...
                outputChannel.appendLine(`[SSB] Stop error: ${e instanceof Error ? e.message : String(e)}`)
        }
